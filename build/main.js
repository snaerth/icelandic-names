...
module.exports = /** *** */ (function (modules) {
  ...
  /** *** */ [
    ...
    /** */ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_fs__ = __webpack_require__(5);
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_fs___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_0_fs__,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_1_mkdirp__ = __webpack_require__(6);
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_1_mkdirp___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_1_mkdirp__,
      );
    ...
    /** */ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_express__ = __webpack_require__(3);
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_express___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_0_express__,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_1_cron__ = __webpack_require__(4);
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_1_cron___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_1_cron__,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_2__utils_fileHelpers__ = __webpack_require__(
        0,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_3__services_nameScraper__ = __webpack_require__(
        7,
      );
      ...
      Object(__WEBPACK_IMPORTED_MODULE_3__services_nameScraper__.a)();
      ...
      app.get('/names', async (req, res) => {
        try {
          const data = await Object(__WEBPACK_IMPORTED_MODULE_2__utils_fileHelpers__.a)(
            './data/names.json',
          );
    ...
    /* 7 */
    /** */ function (module, __webpack_exports__, __webpack_require__) {
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_cheerio__ = __webpack_require__(8);
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_cheerio___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_0_cheerio__,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_1__utils_fetchHtml__ = __webpack_require__(
        9,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_2__utils_createUUID__ = __webpack_require__(
        11,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_3__utils_fileHelpers__ = __webpack_require__(
        0,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_4__utils_delayPromiseBatches__ = __webpack_require__(
        13,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_5__database_icelandic__ = __webpack_require__(
        15,
      );
        ...
        return arr
          .map((i, el) => {
            ...
            const name = $(el.children[0])
              ...
              .trim();
            const obj = {
              id: Object(__WEBPACK_IMPORTED_MODULE_2__utils_createUUID__.a)(name),
              name,
              verdict: null,
              declesions: null,
            };
      ...
      async function getNameDeclesionsForList(list) {
        try {
          ...
          for (const item of list) {
            promises.push(Object(__WEBPACK_IMPORTED_MODULE_5__database_icelandic__.a)(item.name));
          }

          const declesionsList = await Object(
            __WEBPACK_IMPORTED_MODULE_4__utils_delayPromiseBatches__.a,
          )(promises, chunkSize, 1000);
      ...
      /* harmony default export */ __webpack_exports__.a = async function initScraper() {
        try {
          ...
          const html = await Object(__WEBPACK_IMPORTED_MODULE_1__utils_fetchHtml__.a)(url);
          const data = await parseNamesHtml(html);
          await Object(__WEBPACK_IMPORTED_MODULE_3__utils_fileHelpers__.b)(
            './data/names.json',
            JSON.stringify(data),
          );
          return true;
    ...
    /* 9 */
    /** */ function (module, __webpack_exports__, __webpack_require__) {
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_node_fetch__ = __webpack_require__(10);
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_node_fetch___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_0_node_fetch__,
      );
      ...
      /* harmony default export */ __webpack_exports__.a = async function fetchHTML(url) {
        try {
          const res = await __WEBPACK_IMPORTED_MODULE_0_node_fetch___default()(url, {
            timeout: 3000,
          });
    ...
    /** */ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_uuid_v3__ = __webpack_require__(12);
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_uuid_v3___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_0_uuid_v3__,
      );
    ...
    /* 13 */
    /** */ function (module, __webpack_exports__, __webpack_require__) {
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0__utils_splitToChunks__ = __webpack_require__(
        14,
      );

      /* harmony default export */ __webpack_exports__.a = async function delayPromiseBatches(
        promises,
        chunkSize,
        delayMs,
      ) {
        try {
          const promisesInChunks = Object(__WEBPACK_IMPORTED_MODULE_0__utils_splitToChunks__.a)(
            promises,
            chunkSize,
          );
    ...
    /* 15 */
    /** */ function (module, __webpack_exports__, __webpack_require__) {
      /* harmony export (immutable) */ __webpack_exports__.a = getDeclensionByName;
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0__database__ = __webpack_require__(16);
       ...
       */
      async function getDeclensionByName(str) {
        try {
          const { rows } = await Object(__WEBPACK_IMPORTED_MODULE_0__database__.a)(
            'SELECT * FROM bin WHERE uppflettiord = $1',
            [capitalizeFirstLetter(str)],
          );

          const parsedData = parseDeclesionNameResponse(rows);
       ...
       * @example parseDeclesionNameResponse(rows) => ['Snær','Snæ', 'Snæ', 'Snæs']
       */
      function parseDeclesionNameResponse(row) {
        const arr = [];

        for (const item of row) {
          const str = item.greiningarstrengur;

          if (/NF/.test(str)) {
            arr[0] = item.beygingarmynd;
          } else if (/ÞF/.test(str)) {
            arr[1] = item.beygingarmynd;
          } else if (/ÞGF/.test(str)) {
            arr[2] = item.beygingarmynd;
          } else if (/EF/.test(str)) {
            arr[3] = item.beygingarmynd;
          }
        }
    ...
    /** */ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_pg__ = __webpack_require__(17);
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_pg___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_0_pg__,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_1__config__ = __webpack_require__(18);
      ...
      const {
        ...
        DB_PASSWORD,
        DB_PORT,
      } = __WEBPACK_IMPORTED_MODULE_1__config__.a;
    ...
    /* 18 */
    /** */ function (module, __webpack_exports__, __webpack_require__) {
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_dotenv__ = __webpack_require__(19);
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_dotenv___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_0_dotenv__,
      );
